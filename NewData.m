...
%% EDITED FOR MAC
% Slashes replaced to go backwards
% Sarah Patterson
% 11/18/21

%% Set Up
% The derictery of the database of images, and file type
imgPath  = 'Glycophingolipid/*.png';
...
%% Make Original Images(saved in Data)
...
for i = 1:N
    ...
    FNm = strcat("Data_100/", Token);
    FNm = extractBefore(FNm,".png");
